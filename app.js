...
const DATA = {
  ...
  plans: [
    {
      ...
      route: "大阪 → 二見興玉神社・夫婦岩 → 伊勢シーパラダイス（気分次第）→ VISON短時間 → 松阪牛ディナー → 大阪",
      items: [
        ["9:00", "大阪出発", "日曜の渋滞を考え遅すぎない出発。SA/PA休憩1回"],
        ["11:30", "二見興玉神社・夫婦岩 着", "海辺を軽く散歩。景色・夫婦岩・神社"],
        ["12:15", "めおと横丁 / 二見でランチ", "後半に余白を残すため軽めでOK"],
        ["13:00", "伊勢シーパラダイス（任意）", "1〜1.5時間で軽く。疲れ・時間次第で外してOK"],
        ["15:15", "VISON 着", "Confiture H → minä perhonen → D&DEPARTMENT → マルシェ"],
  ...
  /* === 移動ルート === */
  legs: [
    { from: "大阪", to: "二見興玉神社・夫婦岩", time: "約2時間20分", note: "高速中心。日曜午前は渋滞に注意。SA/PA休憩1回" },
